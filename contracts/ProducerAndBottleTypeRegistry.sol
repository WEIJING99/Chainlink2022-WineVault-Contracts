...
contract ProducerAndBottleTypeRegistry {
    ...
    // ****** WHITELIST REQUIRED ******
    function createBottleType(string calldata _name, Varietal _varietal, Style _style, address _producer, Region _region, uint _vintage, uint _size, uint _alcoholContent, uint _standardDrinks, string calldata _description) public {
        BottleType memory newBottleType = BottleType(bottleTypeCount, _name, _varietal, _style, _producer, _region, _vintage, _size, _alcoholContent, _standardDrinks, _description);
